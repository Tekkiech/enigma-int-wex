...
// Backs the /metrics dashboard - synthetic shopper data generated by
// analytics/generate.py, served straight out of the DB (no JSON file
// involved anywhere in that pipeline). Public, no session needed.
